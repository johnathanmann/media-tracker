...
export default function Homepage({handlePageChange }){
    return(
        ...
        <div className='col-lg-5 col-md-12'>
            <h1><span className="rainbow-text1">2023</span><br /><span className="rainbow-text2">Media</span><br /><span className="rainbow-text3">Tracker</span></h1>
          ...
          </div></div><div className="break"><br/></div>
          <div id="icons2">
            <div className="click-to-top">
